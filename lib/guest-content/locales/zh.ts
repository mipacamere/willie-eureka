...
/**
 * Traduzione cinese dei contenuti companion — STUB, non ancora tradotto.
 *
 ...
 */
export const zh: Partial<Record<PropertySlug, PropertyTranslation>> = {
  // TODO: tradurre in cinese
};
